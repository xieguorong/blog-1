        ...
        <form action="{{ url('admin/config/' . $config->conf_id) }}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>类型：</th>
                    <td>
                        <input type="radio" name="field_type" value="input" @if($config->field_type=='input') checked @endif onclick="showTr()">input&nbsp;&nbsp;
                        <input type="radio" name="field_type" value="textarea" @if($config->field_type=='textarea') checked @endif onclick="showTr()">textarea&nbsp;&nbsp;
                        <input type="radio" name="field_type" value="radio" @if($config->field_type=='radio') checked @endif onclick="showTr()">radio&nbsp;&nbsp;
                    </td>
                </tr>
                <tr id="field_value">
                    <th>类型值：</th>
